...
If $Y$ has continuous CDF $F$, then $U = F(Y) \sim \Unif(0,1)$.https://iclr.cc/
https://icml.cc/ https://imstat.
org/journals-and-publications/annals-of-applied-statistics/ https://jmlr.org/
https://neurips.cc/ https://virtual.aistats.org/
\end{proposition}
