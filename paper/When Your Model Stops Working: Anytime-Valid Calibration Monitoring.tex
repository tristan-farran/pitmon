...
\begin{table}[ht]
\centering
\caption{Delivery demo Part 3 comparison using 1{,}000 trials per shift level. 95\% Wilson score confidence intervals are reported for FPR and TPR.}
\label{tab:delivery_part3_compare}
\begin{tabular}{@{}ccccccc@{}}
\toprule
Shift & Method & FPR & FPR CI & TPR & TPR CI & Median Delay \\
\midrule
H$_0$ & PITMonitor & 3.6\% & [2.1\%, 6.1\%] & 0.0\% & [0.0\%, 0.7\%] & n/a \\
H$_0$ & DDM & 11.2\% & [8.5\%, 14.6\%] & 3.2\% & [1.7\%, 5.7\%] & 78.0 \\
H$_0$ & EDDM & 83.0\% & [79.2\%, 86.2\%] & 7.6\% & [5.2\%, 10.9\%] & 55.0 \\
H$_0$ & ADWIN & 0.0\% & [0.0\%, 0.7\%] & 0.0\% & [0.0\%, 0.7\%] & n/a \\
H$_0$ & KSWIN & 0.7\% & [0.2\%, 2.2\%] & 2.1\% & [1.0\%, 4.2\%] & 88.0 \\
\midrule
